        ...
        cards: [
          ...
          },
          {
            ...
            desc: `2026.09.22 ~ 2026.09.25
              ...
              <br>- 권역 지도: 같은 권역의 지역구 사이 경계선을 지우고 권역 둘레만 표시, 라이트 모드에서는 어두운 바탕 대신 밝게 표시 · 미배정 지역구는 빛 효과 없이 단색 + 옅은 경계선으로 권역과 결을 맞춤 · 권역 테두리를 권역 안쪽에 그려 이웃 권역과 겹치거나 일부 권역에 테두리가 빠지던 문제 수정 · 권역 안쪽의 굵은 빛 띠를 없애고 테두리 + 채움색만
