        ...
        cards: [
          ...
          },
          {
            ...
            desc: `2026.09.22 ~ 2026.09.25
              ...
              <br>- 국가 › 설정 탭 신설 — 지역구 시스템(지도 · 그리드)과 지도 글씨 · 배지 크기를 의회 › 의회 설정에서 옮김, 원별 반원 중앙 표시(의석 수 · 로고)는 국가 › 상징에서 의회 › 의회 설정으로
              <br>- 의회 탭 순서 변경: 의회 설정 · 이념 · 정당 · 의회 구성(구 구성) · 집권과 연정 · 지역구 의원 · 비례대표`
          },
          {
            status: 'future',
            title: '1.5.7 - ?',
