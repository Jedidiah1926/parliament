      ...
      '1.4': {
        ...
        cards: [
          ...
          },
          {
            ...
            desc: `2026.08.28
              <br>- 국가명·국기 설정 추가 (국가 > 설정, 헤더에 상시 표시. 국기 지정 시 좌측 패널 폭에 맞춘 배너로 표시, 미지정 시 이름만 표시)
              <br>- 의회 시스템 리워크 III (원외정당 시스템 추가 — 의석이 0인 정당이 우측 정보 패널의 원외정당 섹션에 자동으로 표시)
              <br>- 날짜/회기 설정 추가 (날짜: 단순형·수동 진행형[+1일/+7일/+1개월], 회기: 단순형·개별형[대수·회기 번호·정기회/임시회], 우측 디스플레이 패널 상단에 상시 표시)
              <br>- "저장 시 사진 포함" 체크박스 제거 (항상 사진을 포함하여 저장하도록 변경)
              <br>- 국가 > 설정 신설에 맞춰 시작 화면 기본 탭을 국가 > 설정으로 변경
              <br>- 중위·하위 탭 디자인 정리 (박스형 스타일 통일, 단원제/양원제/삼원제 세그먼트 버튼화)
              <br>- 버그 수정`
          },
          {
            status: 'future',
