        ...
        cards: [
          ...
          },
          {
            ...
            desc: `2026.08.27
              ...
              <br>- 점검 기간 자동화 (maintenance.js에 시작·종료 시각을 지정하면 자동으로 점검 안내 표시 및 리디렉션)
              <br>- 로드맵 카드 업데이트 로그가 길어지면 스크롤되도록 개선 (스크롤바 색은 카드 상태색을 따름)
              <br>- 선거 리워크 (선거 > 지지율 탭 신설, "전체에 반영" 체크박스로 여러 원의 지지율 일괄 설정 지원)
          ...
          },
          {
            ...
            title: '1.4.9 - 저장 리워크',
            desc: `2026 하반기 출시
              <br>- 저장/불러오기 시스템 리워크 (버전명 체계 변경 및 안정화)
